                                    ...
                                    {!isSkipped && (
                                        <div className="space-y-3">
                                            {gymProgress[exercise.id]?.map((set: any, idx: number) => {
                                                ...
                                                return (
                                                    <div key={idx} className={`relative p-3.5 rounded-[2rem] border-2 transition-all duration-300 ${set.completed
                                                                    ...
                                                                    <div className="flex flex-col">
                                                                        ...
                                                                        {(() => {
                                                                            ...
                                                                            const prog = suggestProgression(
                                                                                parseFloat(ghostWeight),
                                                                                parseInt(ghostReps),
                                                                                parseInt(exercise.target) || 8,
                                                                                exercise.visual || '',
                                                                                2, // Default RIR for prev session ghost
                                                            ...
                                                            <button
                                                                onClick={() => {
                                                                    ...
                                                                    setGymProgress((p: any) => {
                                                                        ...
                                                                        o[idx] = { ...o[idx], completed: !o[idx].completed };

                                                                        // Auto-progresión dinámica para la siguiente serie
                                                                        if (!wasCompleted && idx < o.length - 1) {
                                                                            const nextIdx = idx + 1;
                                                                            if (!o[nextIdx].completed) {
                                                                                ...
                                                                                o[nextIdx] = {
                                                                                    ...
                                                                                    reps: o[nextIdx].reps || o[idx].reps // También igualar reps por defecto
                                                                                };
                                                                            }
                                                                        }
                                                                ...
                                                                className={`w-10 h-10 flex items-center justify-center rounded-2xl transition-all shadow-sm ${set.completed ? 'bg-emerald-500 text-white scale-110 shadow-emerald-200' : 'bg-white text-slate-300 active:bg-slate-100'
                                                                    }`}
                                                            >
